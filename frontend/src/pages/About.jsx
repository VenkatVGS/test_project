      ...
      <div className="flex flex-col gap-6">
        ...
        <blockquote className="bg-white shadow-md rounded-2xl p-6 border-l-4 border-primary">
          <p className="text-gray-700 text-lg italic mb-4">
            “At our MRM PG we believe in creating a space where you can live,
            study, and relax with ease. Our PG is designed with comfort, safety,
            and convenience in mind. We offer well-maintained rooms,
            round-the-clock security, and a supportive environment. Whether
            you’re here for studies or work, you’ll always feel welcome.”
          </p>
